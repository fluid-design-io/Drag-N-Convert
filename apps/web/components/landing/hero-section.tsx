        ...
        <div className="mx-auto max-w-7xl pt-24 pb-24 sm:pb-32 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-40">
          ...
          <div className="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
            <div className="mx-auto max-w-none sm:max-w-[672px] md:mx-0 md:max-w-none overflow-hidden relative">
              ...
              <video
                src="https://private-user-images.githubusercontent.com/13263720/414882231-fa3c39b7-851b-4cec-bac5-f533eade902f.mp4?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..XX-Rat3Ng1doC-PyU5_qac_S5gmW4T9k0187mCmamB8"
                autoPlay
                muted
                loop
                className={cn(
